   ...
   <div class="row-fluid banner-content">
		 ...
		 <div class="row-fluid">
				<div class="span12">
					...
					<a href="#myModal" data-toggle="modal" class="btn btn-huge btn-block btn-primary" id="link_employerregister" onclick="return true">Sign Up and Get Your Minyawns Today</a>
          <a href="#myModal" data-toggle="modal" class="btn btn-huge btn-block btn-primary" id="link_minyawnregister" onclick="return true">Minyawn Signup and Apply for Jobs Now</a>
				</div>
