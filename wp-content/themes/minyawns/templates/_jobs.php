...
<div class="accordion-group view" id="job-accordion-
<%= result.post_id %>
">
  <div id="last-job-id" last-job="
<%= result.post_id %>
" value="
<%= result.post_id %>
">
  ...
  <div class="span12 data-title available">
    <div class="job-logo header-sub">
      ...
      <div class="job-date header-sub">
        <span class="service-total-demand" data-count="0">
          <%= result.job_start_day %>
          </span>
          <div>
            <%= result.job_start_month %>
              <b class="service-client-demand" data-count="0">
                <%= result.job_start_year %>
                </b>
              </div>
              <div class="demand">
                <%= result.job_day %>
              ...
              <div class="job-time header-sub duration_mob">
                <div class="row-fluid">
                  <div class="span5 mob-botm">
                    <span data-count="0" class="total-exchange-count">
                      ...
                      <div class="job-wage header-sub">
                        ...
                        <div id="collapse
<%= result.post_id %>
" class="accordion-body  single-jobs collapse " >
...
<?php echo site_url() ?>
/profile/
<%= result.job_author_id%>
" target="_blank" class="request_link">
  <%= result.job_author %>
  </a>
  </div>
      </div>
      <div class="row-fluid minywans_list">
        ...
        <div class="row-fluid minywans_list">
          ...
          <div class="span9" style=" margin-bottom: 13px;
              ...
              <result.tags.length;i++){ %>
                ...
                <div class="row-fluid minywans_list">
                  ...
                  <div class="span9">
                    ...
                    <% for(i=0;i
                    <result.job_categories.length;i++){ %>
                      
                      <span class="category-link" style="cursor: pointer; cursor: hand;" onclick="filter_categories('
<%= result.job_category_ids[i] %>
','
<%= result.job_categories[i]%>
')">
  <%= result.job_categories[i] %>
  </span>
  <%}%>
...
/images/left-arrow.png">
  ...
  <div class="span3 action">
    ...
    <div class="div-box-block">
      <span class='load_ajax1' style="display:none">
      </span>
      <%=  job_collapse_button%>
...
<?php echo site_url() . '/paypal-payments/'; ?>
" / >
      <input type='hidden' name='hdn_jobwages' id='hdn_jobwages' value='' />
      <div class="row-fluid minyawns-grid">
        <ul class="thumbnails">
          <span class='load_ajaxsingle_job_minions' style="display:none">
          </span>
        </ul>
      </form>
  </div>
