            ...
            <div id="edit-job-form" class="span12" style=" margin-left: 30px; width: 95%;display: none " >
                ...
                <form id="job-form" class="form-horizontal">
                    ...
                    <div class="input-append bootstrap-timepicker">
                        <input id="job_start_time" type="text" value="<?php echo $minyawn_job->get_start_time_eform() ?>" class="timepicker-default input-small" name="job_start_time"/><?php echo $minyawn_job->get_job_start_time()  ?>
                        <span class="add-on">
                            <i class="icon-time"></i>
                        </span>
                    </div>
