      ...
      <div class="alert alert-info job-sidebar previous-jobs previous-jobs-mobile">                          
                                    ...
                                    <form id="job-form" class="form-horizontal">
                                        ...
                                        <div class="input-append bootstrap-timepicker controls" style=" margin-left: 10px; ">
                                            <input id="job_start_time" type="text" class="timepicker-default input-small" name="job_start_time" value="<?php echo $minyawn_job->get_job_start_time()  ?>"><?php echo $minyawn_job->get_job_start_time()  ?></input>
                                            <span class="add-on">
                                                <i class="icon-time"></i>
                                            </span>
                                        </div>
