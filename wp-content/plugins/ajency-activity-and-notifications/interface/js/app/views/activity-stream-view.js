    ...
    return App.module("ListActivity.Views", function(Views, App) {
      ...
      return Views.ShowPackage = (function(_super) {
        ...
        ShowPackage.prototype.onShow = function() {
          return console.log("viewshw" + NOAVATAR);
        };
